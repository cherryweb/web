...
namespace WebApplication1
{
    public partial class masVotadas : System.Web.UI.Page
    {
        ...
        //Intento de sacar imagenes en el GridView.
        protected void grdAplicaciones_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            var aplicacion = e.Row.DataItem as ENAplicaciones;

            if (aplicacion != null)
            {
                var image = e.Row.FindControl("imgApp") as Image;
                image.ImageUrl = "~Imagenes/chendilon.png";
            }
        }
    }
}